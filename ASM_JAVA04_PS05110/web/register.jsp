                    ...
                    <div class="row">
                        ...
                        <div class="span9" style="float: left">
                            ...
                            <form action="Controller" method="post">
                                Login:<br><input type="text" name="txtUser"><br>
                                Password:<br><input type="password" name="txtPass"><br>
                                Fist Name:<br><input type="text" name="txtfirstname"><br>
                                Last Name:<br><input type="text" name="txtlastname"><br>
                                E-Mail:<br><input type="text" name="txtemail"><br>
