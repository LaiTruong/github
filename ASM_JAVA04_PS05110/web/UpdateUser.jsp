                    ...
                    <div class="row">
                        ...
                        <div class="span9" style="float: left">
                            ...
                            <form action="Controller" method="post">
                                Login:<br><input type="text" name="txtUser" value="<%= request.getAttribute("username")%>"><br>
                                ...
                                <input class="btn btn-success" type="submit" value="Update account" name="btnAction" />
                            </form>
                        </div>
                    </div>
                </div>
