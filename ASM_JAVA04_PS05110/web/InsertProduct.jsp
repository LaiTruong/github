<%-- 
    ...
    Created on : Jul 3, 2017, 8:42:23 PM
    Author     : Admin
--%>
<%-- 
    Document   : UpdateUser
                    ...
                    <div class="row">
                        ...
                        <div class="span9" style="float: left">
                            ...
                            <form action="ControllerAdmin" method="post">
                                ...
                                Ten San Pham:<br><input type="text" name="txtTensp" value="<%= request.getAttribute("Tensp")%>"><br>
                                Gia moi:<br><input type="text" name="txtGiamoi" value="<%= request.getAttribute("Giamoi")%>"><br>
                                Gia cu:<br><input type="text" name="txtGiacu" value="<%= request.getAttribute("Giacu")%>"><br>
                                Image:<br><input type="text" name="txtImage" value="<%= request.getAttribute("Image")%>"><br>
                                Mota:<br><input type="text" name="txtMota" value="<%= request.getAttribute("Mota")%>"><br><br>
                                <input class="btn btn-success" type="submit" value="Insert Product" name="btnAction" />
                            </form>
                        </div>
                    </div>
                </div>
