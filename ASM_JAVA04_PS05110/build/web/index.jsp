                        ...
                        <div class="latest-product">
                            ...
                            <div class="product-carousel">
                                <%
                                    ...
                                    SanPham[] list = sp.showsp();

                                    for (int i = 0; i < list.length; i++) {
                                        id = list[i].getId();
                                        Tensp = list[i].getTensp();
                                        Giamoi= list[i].getGiamoi();
                                        Giacu = list[i].getGiacu();
                                ...
                                <div class="single-product">
                                    ...
                                    <h2><a href="single-product.jsp"><%= Tensp%></a></h2>

                                    <div class="product-carousel-price">
                                        <ins><%= Giamoi%></ins> <del><%= Giacu%></del>
                                    </div> 
                                </div>
                                <%}
                                %>
        ...
        <div class="footer-bottom-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <div class="copyright">
                            <p>&copy; 2017 LaiTruong. All Rights Reserved. <a href="http://www.freshdesignweb.com" target="_blank">LaiTruongDesignweb.com</a></p>
                        </div>
                    </div>
