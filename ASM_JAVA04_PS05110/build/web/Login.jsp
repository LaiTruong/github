                        ...
                        <div class="span9">
                            ...
                            <section class="newcustomer">
                                ...
                                <div class="loginbox">
                                    ...
                                    <br>
                                    <br>
                                    <a href="register.jsp" class="btn btn-success">Continue</a>
                                </div>
                            </section>
                                    ...
                                    <form class="form-vertical" action="login" method="post" >
                                        <fieldset>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="txtUsername" value=""  class="span3">
                                                </div>
                                            </div>
                                            <div class="control-group">
                                            ...
                                            <input class="btn btn-success" type="submit" value="Login" name="btnAction">
